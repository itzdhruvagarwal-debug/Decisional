...
export const INDIA_COMPLIANCE_SOURCES = {
  gstRegistration:
  ...
  tds194j: "https://www.incometaxindia.gov.in/w/section-194j-28",
  ecommerceTds194o: "https://www.incometaxindia.gov.in/w/section-194-o",
  eInvoice:
    "https://einvoice6.gst.gov.in/content/new-advisory-on-e-invoicing-enablement-status-update-for-taxpayers/",
} as const;

export const PAN_REGEX = /^[A-Z]{5}[0-9]{4}[A-Z]$/;
export const GSTIN_REGEX = /^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z][1-9A-Z]Z[0-9A-Z]$/;
export const ITR_ACK_REGEX = /^[0-9]{10,20}$/;
export const ASSESSMENT_YEAR_REGEX = /^20[0-9]{2}-[0-9]{2}$/;
