...
export const homeTestimonials = [
  {
    ...
    quote:
      "The deal screen makes expectations clear before I start creating. That removes a lot of back-and-forth.",
    rating: 5,
  },
  {
    ...
    quote:
      "Contracts, approvals, and payment checks live in one workflow, so our campaign team has a cleaner audit trail.",
    rating: 5,
  },
  {
    ...
    quote:
      "Badges and referrals are useful because they connect directly to real activity instead of vanity points.",
    rating: 5,
  },
];
