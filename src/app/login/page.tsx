  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // Use a single generic error for all failure modes to prevent user enumeration.
        // Distinct messages ("email not found" vs "wrong password") let attackers
        // trivially build registered-email lists from any credential dataset.
      ...
      const errorMsg = (err instanceof Error ? (err instanceof Error ? (err instanceof Error ? err.message : String(err)) : String(err)) : String(err)) || (err instanceof Error ? (err instanceof Error ? (err instanceof Error ? err.name : 'Error') : 'Error') : 'Error') || String(err);
