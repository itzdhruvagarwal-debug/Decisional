...
async function handleNotificationPreferences(userId: string, body: any) {
...
async function updateInfluencerProfile(userId: string, email: string, data: any) {
...
async function updateBrandProfile(userId: string, email: string, data: any) {
