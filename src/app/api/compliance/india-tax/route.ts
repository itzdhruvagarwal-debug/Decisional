...
function determineGstAndPanState(
  ...
  const nextRegistrationType = Object.prototype.hasOwnProperty.call(bodyRecord, "gstRegistrationType")
  ...
  const nextGstin = registeredForGst ? (data.gstin ?? currentGstin) : undefined;
...
function buildComplianceUpdatePayload(
  ...
  const updateData: Record<string, any> = {
    ...
    tdsSection: userType === "BRAND" ? "194J_OR_194O_REVIEW" : "194J_REVIEW",
