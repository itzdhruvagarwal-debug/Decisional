    ...
    <DashboardShell user={session?.user}>
      <div className="flex flex-col gap-6 max-w-900 mx-auto">
        ...
        <div className="card flex gap-6 flex-wrap p-8">
          <div className="flex items-center justify-center font-extrabold flex-shrink-0 rounded-full text-3xl bg-gradient-primary text-white influencer-avatar">
        ...
        <div className="grid gap-6 influencer-detail-grid">
          ...
          <div className="card stagger-children p-6">
            ...
            <div className="flex justify-between border-b-card mb-4 pb-4">
              <div>
