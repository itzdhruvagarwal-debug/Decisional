...
export default function CreateCampaignClient() {
  ...
  const handleDeliverableChange = (
    ...
    newDeliverables[index] = { ...newDeliverables[index]!, [field]: value } as { type: string; count: number };
        ...
        <form>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    perInfluencerBudget: parseInt(e.target.value) || 0,
                  })
                }
                required
                min={100}
          ...
          >
            ...
            <button
              ...
              disabled={isLoading}
            >
              {isLoading ? <span className="loading" /> : "Create Campaign"}
            </button>
          </div>
        </form>
      </div>
