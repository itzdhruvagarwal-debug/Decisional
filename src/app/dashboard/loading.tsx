...
export default function Loading() {
  return (
    <div className="dashboard-app-shell">
      ...
      >
        {/* Logo area */}
        <div className="border-b-card dashboard-loading-logo">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        {/* Topbar skeleton */}
        <header
          className="glass flex items-center justify-between border-b-card backdrop-blur-lg h-16 dashboard-loading-topbar"
          aria-hidden="true"
        >
          <div>
