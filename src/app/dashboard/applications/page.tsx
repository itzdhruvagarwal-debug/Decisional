    ...
    fetch(`/api/applications?page=${page}&limit=${limit}`, { cache: "no-store" })
      ...
      .catch((err) => {
        ...
        if (err?.name !== "AbortError") {
          console.error("[applications-page] Failed to fetch applications:", err);
        ...
        {loading ? (
          ...
          >
            ...
            <p style={{ color: "var(--color-text-secondary)", fontSize: "14px", marginBottom: "20px" }}>
              You haven't applied to any campaigns yet. Discover available campaigns to start pitching!
            </p>
