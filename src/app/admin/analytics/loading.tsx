    ...
    <div className="admin-page" aria-hidden="true">
      ...
      <div className="grid gap-6 grid-auto-360">
        <div className="card p-6">
          ...
          <div className="skeleton rounded-md" style={{ height: 220 }} />
        </div>
        <div className="card p-6">
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                <div className="skeleton h-3.5 rounded-sm mb-2" style={{ width: "65%" }} />
                <div className="skeleton h-3 rounded-sm" style={{ width: "45%" }} />
              </div>
