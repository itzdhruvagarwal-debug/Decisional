...
<div
key={app.id}
className="card p-6 flex flex-col gap-4 bg-rose-02 border-rose-subtle"
>
...
<div className="flex justify-between items-center flex-wrap gap-4 border-t border-card pt-4">
<div>
