...
export default function AdminPayoutsError({
  ...
  return (
    <div role="alert" aria-live="assertive" className="admin-page flex flex-col items-center justify-center gap-5" style={{ minHeight: "60vh" }}>
      ...
      <p className="text-secondary text-sm text-center" style={{ maxWidth: 400 }}>Payout queue could not be fetched. Check payment service connectivity and try again.</p>
