...
{engagement.snapshots.map((snap: EngagementSnapshot & { interval?: string; isEstimated?: boolean }) => (
<div key={snap.interval || "snapshot"} className="p-3 bg-tertiary rounded-sm border-card engagement-snapshot">
