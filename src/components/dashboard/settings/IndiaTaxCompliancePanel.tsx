...
export default function IndiaTaxCompliancePanel() {
  ...
  async function loadCompliance() {
    ...
    try {
      ...
      setError(err instanceof Error ? (err instanceof Error ? err.message : String(err)) : "Failed to load tax compliance");
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(err instanceof Error ? (err instanceof Error ? err.message : String(err)) : "Failed to save tax compliance");
    } finally {
      setSaving(false);
    }
  }
