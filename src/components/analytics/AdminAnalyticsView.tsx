    ...
    >
      ...
      <motion.div variants={itemVariants} className="card relative overflow-hidden group border border-white/10 glass">
        ...
        <div className="relative z-10 p-6 sm:p-8">
          ...
          <div className="w-full mt-4" style={{ height: 350, minWidth: 0, overflowX: "auto" }}>
            {chartsReady && (
              <BarChart width={920} height={350} data={data.financials.revenueHistory} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={itemVariants} className="card lg:col-span-2 relative overflow-hidden group border border-white/10 glass p-6 sm:p-8">
          ...
          <div className="relative z-10">
            ...
            <div className="w-full" style={{ height: 280, minWidth: 0, overflowX: "auto" }}>
              {chartsReady && (
                  <LineChart width={820} height={280} data={data.growth} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  <defs>
...
function MetricCard({ icon, label, value, gradient, textColor }: any) {
  return (
...
function HealthRow({ label, value, color }: { label: string; value: string | number; color: string }) {
  return (
