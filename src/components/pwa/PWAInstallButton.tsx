...
function getPlatformCopy(platform: InstallPlatform) {
  ...
  return {
    ...
    steps: ["On Android, use Chrome's Install app prompt.", "On iPhone, open Safari and use Share > Add to Home Screen.", "The installed app opens full-screen and works like a mobile app."],
  };
}
