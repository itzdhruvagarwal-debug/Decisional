 ...
 *
 * Creates:
 *  - 1 Admin        (admin@test.decisional.in  / Test@1234)
 *  - 1 Brand        (brand@test.decisional.in  / Test@1234)  --- Rs 1,00,000 wallet
 *  - 1 Influencer   (influencer@test.decisional.in / Test@1234)
 *
 * All accounts: KYC FULL, emailVerified, phoneVerified, docs VERIFIED, Tax Ready, Bank Accounts seeded
 *
 * Run:  npx tsx scripts/seed-test-accounts.ts
 * Override default password: TEST_ACCOUNT_PASSWORD=<password> npx tsx scripts/seed-test-accounts.ts
 */
